...
$$
The dispersion relation of the conduction band is isotropic. This allows us to move from the 3-dimensional momentum space to the 1-dimensional energy space using the [A2 - Electronitc Density of States](A2%20-%20Electronic%20Density%20of%20States.md), namely
$$
d^{3}k\to \rho(\mathcal{E})d\mathcal{E} = \frac{4\pi \sqrt{2m_{e}^{3}\mathcal{E}}}{\hbar^3} \ d\mathcal{E}
$$
$$
\Gamma_{\text{cc}}(\hbar\omega) = \frac{2\pi}{\hbar}\left( \frac{2\mu_{\text{cc}}V}{(2\pi)^{3}} \right)^{2} \iint\limits_{\text{BZ}} f(\mathcal{E}_{c\text{i}})\overline{f(\mathcal{E_{\text{cf}}})}  \ \delta(\mathcal{E_{\text{ci}}-\mathcal{E}_{\text{cf}}-\hbar\omega}) \ \rho(\mathcal{E}_{\text{ci}}) \rho(\mathcal{E}_{\text{cf}})d\mathcal{E}_{\text{ci}}d\mathcal{E}_{\text{cf}}
$$
In energy space, the delta can be easily resolved
$$
\Gamma_{\text{cc}}(\hbar\omega) = \frac{2\pi}{\hbar}\left( \frac{2\mu_{\text{cc}}V}{(2\pi)^{3}} \right)^{2} \int\limits_{\text{BZ}} f(\mathcal{E}_{c\text{i}})\overline{f(\mathcal{E_{\text{ci}}-\hbar\omega})}  \ \ \rho(\mathcal{E}_{\text{ci}}) \rho(E_{\text{ci}}-\hbar\omega)d\mathcal{E}_{\text{ci}}
$$
